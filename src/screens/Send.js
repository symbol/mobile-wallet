...
import { Section, GradientBackground, TitleBar, Input, InputAddress, Button, Dropdown } from '@src/components';
...
class Send extends Component<Props, State> {
    ...
    render = () => {
        ...
        const mosaicList = [{ value: 'symbol.xym', label: 'Symbol.XYM' }];
        ...
        return isConfirmShown ? (
            ...
            <GradientBackground name="connector_small" theme="light">
                ...
                <Section type="form" style={styles.list} isScrollable>
                    ...
                    <Section type="form-item">
                        <Dropdown value={mosaicName} title="Mosaic" theme="light" editable={true} list={mosaicList} onChange={mosaicName => this.setState({ mosaicName })} />
                    </Section>
                    <Section type="form-item">
