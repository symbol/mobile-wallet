...
class CreateAccount extends Component {
    ...
    startScanner = () => {
        Router.scanQRCode(this.parseScannedQR, () => {
            Router.goBack(this.props.componentId);
        });
    };
    ...
    renderButton = (buttonName, payload, i, count) => {
        ...
        switch (buttonName) {
            ...
            case 'broadcastSignedQR':
                action = () => {
                    store.dispatchAction({
                        type: 'transfer/broadcastSignedTransaction',
                        payload,
                    });
                    Router.showMessage({
            ...
            case 'broadcastCoSignedQR':
                action = () => {
                    store.dispatchAction({
                        type: 'transfer/broadcastCosignatureSignedTransaction',
                        payload,
                    });
                    Router.showMessage({
                        message: translate('unsortedKeys.announce_success'),
        ...
        try {
            ...
            switch (type) {
                ...
                case QRService.QRCodeType.ExportAddress:
                    ...
                    text = translate('unsortedKeys.accountAddressQRInfo', {
                ...
                case QRService.QRCodeType.RequestTransaction:
                    ...
                    text = translate('unsortedKeys.invoiceTransactionQRInfo', {
                        amount: data.amount,
            ...
            } else this.setState({ isError: true, errorMessage: e.message });
        }
        this.setState({
            isLoading: false,
            title,
                ...
                <Section type="form-without-padding" isScrollable>
                    {!!warning && (
                        <Section type="form-item">
                            <Text theme="dark" type="warning">
                                {translate('qr.' + warning)}
                            </Text>
                        </Section>
                    )}
                    <Section type="form-item">
