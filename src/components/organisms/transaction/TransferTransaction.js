...
class TransferTransaction extends BaseTransactionItem<Props> {
    ...
    hasCustomMosaics = () => {
        ...
        return (
            (currencyMosaic && transaction.mosaics.length > 1) ||
            (!currencyMosaic && transaction.mosaics.length > 0)
        );
    };
    ...
    decryptMessage = async () => {
        const callback = async () => {
            ...
            const messageDecrypted = await TransactionService.decryptMessage(
                selectedAccount,
                network,
                transaction
            );
    ...
    renderDetails = () => {
        ...
        if (transaction.messageText && !transaction.messageEncrypted)
            parsedData.messageText = transaction.messageText;
        ...
        return (
            <View>
                ...
                {!!transaction.messageEncrypted &&
                    ...
                    transaction.messageText.length > 0 && (
