...
export default class CircleMetadata extends GraphicComponent {
    gradientId = 'metadata-circle-gradient';
    stopColor1 = '#a5fab3';
    stopColor2 = '#33dd50';
    ...
    render() {
        return (
            ...
            >
                ...
                />
                <G>
                    <Path fill="#FFFFFF" stroke="#FFFFFF" strokeMiterlimit="10" d="M19.82,18.9c2.3-0.36,4.13-2.03,4.13-3.97
