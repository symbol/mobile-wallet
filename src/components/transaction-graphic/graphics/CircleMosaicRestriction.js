        ...
        return (
            <G version="1.1" x={this._x} y={this._y} width="38.5px" height="38.167px" viewBox="0 0 38.5 38.167">
                ...
                <G>
                    ...
                    />
                    <Path fill="#FFFFFF" d="M27.43,21.333v-2.87c0.221-0.09,0.45-0.19,0.67-0.3C28.31,19.984,28.38,20.683,27.43,21.333z" />
                    <Path
                        fill="#FFFFFF"
                    ...
                    />
                    <Circle id="mark-bottom_1_" fill="#FF00FF" cx="25.343" cy="27.994" r="1.343" />
                    <Path
                        id="mark-top"
                        fill="#FF00FF"
