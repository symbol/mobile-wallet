...
export default class {
        ...
        try {
            ...
            switch (type) {
                ...
                case QRCodeType.CosignatureSignedTransaction:
                    return this.parseCosignatureSignedTransaction(
                        data,
                        network
                    );
                default:
    ...
    static parseSignedTransaction = async (data, network) => {
        ...
        const qr = QRCodeGenerator.fromJSON(
            JSON.stringify(data),
            undefined,
            undefined,
            mapper
    ...
    static parseRequestTransaction = async (data, network) => {
        ...
        const formattedMosaic = await this.formatMosaic(
            transaction.mosaics[0],
            network
        );
