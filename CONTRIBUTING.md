...
1. Make sure that there is a github issue(Feature/Bug) which clearly communicates your concern.
2. This project, at the moment, requires all your commits to be [GPG signed](https://help.github.com/en/github/authenticating-to-github/ signing-commits).
